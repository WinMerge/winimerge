...
for %%i in ( ^
  ...
  if "%1" == "Win32" (
    MSBuild %%i /t:build /p:Configuration=Release /p:Platform="%1" /p:PlatformToolset=v141_xp || goto :eof
  ) else (
    MSBuild %%i /t:build /p:Configuration=Release /p:Platform="%1" /p:PlatformToolset=v141 || goto :eof
  )
)
